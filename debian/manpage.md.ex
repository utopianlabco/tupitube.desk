% tupitube-0.2.23(SECTION) | User Commands
%
% "September 16 2025"
...
tupitube-0.2.23 - program to do something

# SYNOPSIS

**tupitube-0.2.23** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**tupitube-0.2.23** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **tupitube-0.2.23** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**tupitube-0.2.23** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    tupitube-0.2.23. See **foo.conf**(5) for further details.
...
**tupitube-0.2.23** provides some return codes, that can be used in scripts:
...
xtingray <info@tupitube.com>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 xtingray
