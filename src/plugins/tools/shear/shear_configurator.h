...
#ifndef SHEAR_CONFIGURATOR_H
#define SHEAR_CONFIGURATOR_H
...
class TUPITUBE_PLUGIN ShearConfigurator : public QFrame
{
    Q_OBJECT
    ...
    public:
        ...
        ShearConfigurator(QWidget *parent = nullptr);
        ~ShearConfigurator();
    ...
    private:
        ...
        ShearConfigurator::GuiState state;
};
